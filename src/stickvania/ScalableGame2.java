 ...
 */
public class ScalableGame2 implements Game {
	 ...
	 */
	public ScalableGame2(Game held, int normalWidth, int normalHeight) {
	 ...
	 */
	public ScalableGame2(
      Game held, int normalWidth, int normalHeight, boolean maintainAspect) {
		this.held = held;
